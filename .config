...
# CONFIG_TARGET_allwinner is not set
# CONFIG_TARGET_d1 is not set
# CONFIG_TARGET_sunxi is not set
# CONFIG_TARGET_amlogic is not set
...
# CONFIG_TARGET_econet is not set
...
# CONFIG_TARGET_microchipsw is not set
...
# CONFIG_TARGET_phytium is not set
...
CONFIG_DEFAULT_kmod-r8126-rss=y
...
# CONFIG_KERNEL_EROFS_FS is not set
...
CONFIG_KERNEL_EROFS_FS_POSIX_ACL=y
...
CONFIG_KERNEL_EROFS_FS_SECURITY=y
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_VERSION is not set
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_PATH_TRAVERSAL_PROTECTION is not set
...
# CONFIG_BUSYBOX_DEFAULT_SHA384SUM is not set
...
CONFIG_BUSYBOX_DEFAULT_TIMEOUT=y
...
# CONFIG_BUSYBOX_DEFAULT_USE_BB_CRYPT_YES is not set
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_FDISK_BLKSIZE is not set
...
# CONFIG_BUSYBOX_DEFAULT_LSBLK is not set
...
# CONFIG_BUSYBOX_DEFAULT_UUIDGEN is not set
...
# CONFIG_BUSYBOX_DEFAULT_SSL_SERVER is not set
...
# CONFIG_BUSYBOX_DEFAULT_FEATURE_TELNETD_SELFTEST_DEBUG is not set
...
# CONFIG_BUSYBOX_DEFAULT_VMSTAT is not set
...
# CONFIG_BUSYBOX_DEFAULT_HUSH_NEED_FOR_SPEED is not set
...
# CONFIG_BUSYBOX_DEFAULT_HUSH_ALIAS is not set
# CONFIG_BUSYBOX_DEFAULT_HUSH_FUNCTIONS is not set
# CONFIG_BUSYBOX_DEFAULT_HUSH_FUNCTION_KEYWORD is not set
...
# Generic options
#
CONFIG_DROPBEAR_LEGACY_COMPAT=y
CONFIG_DROPBEAR_SMALL_CODE=y
CONFIG_DROPBEAR_DEBUG_TRACE=0
# CONFIG_DROPBEAR_LOG_COMMANDS is not set
# CONFIG_DROPBEAR_INETD_MODE is not set

#
# Login options
#
# CONFIG_DROPBEAR_DO_HOST_LOOKUP is not set
CONFIG_DROPBEAR_SVR_PUBKEY_OPTIONS=y

#
# * note: lastlog/login()/utmp/wtmp are unavailable with musl libc
#

#
# Features
#
CONFIG_DROPBEAR_REEXEC=y
# CONFIG_DROPBEAR_ZLIB is not set
CONFIG_DROPBEAR_DELAY_HOSTKEY=y
CONFIG_DROPBEAR_SVR_AGENTFWD=y
CONFIG_DROPBEAR_SVR_REMOTETCPFWD=y
CONFIG_DROPBEAR_SVR_LOCALTCPFWD=y
CONFIG_DROPBEAR_SVR_LOCALSTREAMFWD=y
# CONFIG_DROPBEAR_X11FWD is not set
CONFIG_DROPBEAR_SCP=y
CONFIG_DROPBEAR_SFTPSERVER=y
CONFIG_DROPBEAR_DBCLIENT=y
CONFIG_DROPBEAR_USER_ALGO_LIST=y
# CONFIG_DROPBEAR_USE_SSH_CONFIG is not set
# CONFIG_DROPBEAR_CLI_IMMEDIATE_AUTH is not set
CONFIG_DROPBEAR_USE_PASSWORD_ENV=y
# CONFIG_DROPBEAR_CLI_ASKPASS_HELPER is not set
CONFIG_DROPBEAR_CLI_AGENTFWD=y
CONFIG_DROPBEAR_CLI_LOCALTCPFWD=y
CONFIG_DROPBEAR_CLI_REMOTETCPFWD=y
CONFIG_DROPBEAR_CLI_PROXYCMD=y
# CONFIG_DROPBEAR_CLI_NETCAT is not set

#
# Multi-hop support is unavailable: enable both DROPBEAR_CLI_NETCAT and DROPBEAR_CLI_PROXYCMD
#

#
# Resource limits
#
CONFIG_DROPBEAR_KEX_REKEY_TIMEOUT=28800
CONFIG_DROPBEAR_KEX_REKEY_DATA=1073741824
CONFIG_DROPBEAR_AUTH_TIMEOUT=300
CONFIG_DROPBEAR_MAX_AUTH_TRIES=10
CONFIG_DROPBEAR_MAX_PUBKEY_QUERIES=15
CONFIG_DROPBEAR_UNAUTH_CLOSE_DELAY=0
CONFIG_DROPBEAR_MAX_UNAUTH_PER_IP=5
CONFIG_DROPBEAR_MAX_UNAUTH_CLIENTS=30
CONFIG_DROPBEAR_DEFAULT_RECV_WINDOW=262144
CONFIG_DROPBEAR_DEFAULT_KEEPALIVE=0
CONFIG_DROPBEAR_DEFAULT_KEEPALIVE_LIMIT=3
CONFIG_DROPBEAR_DEFAULT_IDLE_TIMEOUT=0
CONFIG_DROPBEAR_DEFAULT_MAX_DURATION=0
...
#
# CONFIG_DROPBEAR_3DES is not set
CONFIG_DROPBEAR_AES128=y
CONFIG_DROPBEAR_AES256=y
CONFIG_DROPBEAR_CHACHA20POLY1305=y

#
# Cipher modes:
#
CONFIG_DROPBEAR_ENABLE_CTR_MODE=y
# CONFIG_DROPBEAR_ENABLE_CBC_MODE is not set
# CONFIG_DROPBEAR_ENABLE_GCM_MODE is not set

#
# Message authentication codes (MAC):
#
# CONFIG_DROPBEAR_SHA1_96_HMAC is not set
# CONFIG_DROPBEAR_SHA1_HMAC is not set
CONFIG_DROPBEAR_SHA2_256_HMAC=y
# CONFIG_DROPBEAR_SHA2_512_HMAC is not set

#
# Asymmetric-key ciphers:
#
# CONFIG_DROPBEAR_DSS is not set
# CONFIG_DROPBEAR_RSA_SHA1 is not set
CONFIG_DROPBEAR_RSA=y
CONFIG_DROPBEAR_DEFAULT_RSA_SIZE=2048
# CONFIG_DROPBEAR_ECDSA is not set
CONFIG_DROPBEAR_ED25519=y

#
# Key exchange algorithms
#
# CONFIG_DROPBEAR_DH_GROUP1 is not set
# CONFIG_DROPBEAR_DH_GROUP14_SHA1 is not set
CONFIG_DROPBEAR_DH_GROUP14_SHA256=y
# CONFIG_DROPBEAR_DH_GROUP16 is not set
# CONFIG_DROPBEAR_ECDH is not set
CONFIG_DROPBEAR_CURVE25519=y
# CONFIG_DROPBEAR_MLKEM768 is not set
CONFIG_DROPBEAR_SNTRUP761=y
CONFIG_DROPBEAR_SK_KEYS=y
CONFIG_DROPBEAR_SK_ED25519=y
...
# CONFIG_WIFI_SCRIPTS_WPS_BUTTON_DISABLED is not set
...
# Boot Loaders
#
# CONFIG_PACKAGE_gnu-efi-programs is not set
CONFIG_PACKAGE_grub2=y
CONFIG_PACKAGE_grub2-efi=y
# CONFIG_PACKAGE_grub2-efi-arm is not set
# CONFIG_PACKAGE_grub2-efi-loongarch64 is not set
...
# CONFIG_PACKAGE_aeonsemi-as21xxx-firmware is not set
# CONFIG_PACKAGE_aic8800-pcie-firmware is not set
# CONFIG_PACKAGE_aic8800-sdio-firmware is not set
# CONFIG_PACKAGE_aic8800-usb-firmware is not set
# CONFIG_PACKAGE_aircard-pcmcia-firmware is not set
# CONFIG_PACKAGE_airoha-an7583-npu-firmware is not set
# CONFIG_PACKAGE_airoha-en7581-mt7996-npu-firmware is not set
# CONFIG_PACKAGE_airoha-en7581-npu-firmware is not set
...
# CONFIG_PACKAGE_brcmfmac-firmware-43430b0-sdio is not set
# CONFIG_PACKAGE_brcmfmac-firmware-43455-sdio-phicomm-n1 is not set
...
# CONFIG_PACKAGE_brcmfmac-nvram-43430b0-sdio is not set
...
# CONFIG_PACKAGE_eip197-firmware is not set
...
# CONFIG_PACKAGE_rtl8812au-firmware is not set
# CONFIG_PACKAGE_rtl8814a-firmware is not set
# CONFIG_PACKAGE_rtl8821ae-firmware is not set
# CONFIG_PACKAGE_rtl8821au-firmware is not set
...
# Bluetooth Support
#
# CONFIG_PACKAGE_kmod-aic8800-btusb is not set
...
# CONFIG_PACKAGE_kmod-fs-nilfs2 is not set
...
# CONFIG_PACKAGE_kmod-hwmon-adt7470 is not set
# CONFIG_PACKAGE_kmod-hwmon-adt7475 is not set
CONFIG_PACKAGE_kmod-hwmon-core=y
# CONFIG_PACKAGE_kmod-hwmon-coretemp is not set
# CONFIG_PACKAGE_kmod-hwmon-corsair-cpro is not set
...
# CONFIG_PACKAGE_kmod-pmbus-sensors is not set
...
# CONFIG_PACKAGE_kmod-i2c-hid-acpi is not set
# CONFIG_PACKAGE_kmod-i2c-i801 is not set
# CONFIG_PACKAGE_kmod-i2c-mlxcpld is not set
# CONFIG_PACKAGE_kmod-i2c-mux is not set
# CONFIG_PACKAGE_kmod-i2c-mux-gpio is not set
# CONFIG_PACKAGE_kmod-i2c-mux-mlxcpld is not set
...
# CONFIG_PACKAGE_kmod-iio-dps310 is not set
...
# CONFIG_PACKAGE_kmod-iio-mcp3422 is not set
# CONFIG_PACKAGE_kmod-iio-richtek-rtq6056 is not set
...
# CONFIG_PACKAGE_kmod-hid-alps is not set
...
# CONFIG_PACKAGE_kmod-input-matrix-keypad is not set
# CONFIG_PACKAGE_kmod-input-matrixkmap is not set
# CONFIG_PACKAGE_kmod-input-mouse-ps2 is not set
# CONFIG_PACKAGE_kmod-input-serio is not set
# CONFIG_PACKAGE_kmod-input-serio-libps2 is not set
...
# CONFIG_PACKAGE_kmod-leds-mlxcpld is not set
...
# CONFIG_PACKAGE_kmod-ledtrig-network is not set
...
# CONFIG_PACKAGE_kmod-dsa-notag is not set
...
# CONFIG_PACKAGE_kmod-hinic is not set
...
# CONFIG_PACKAGE_kmod-mlxsw-core is not set
# CONFIG_PACKAGE_kmod-mlxsw-i2c is not set
...
# CONFIG_PACKAGE_kmod-phy-aeonsemi-as21xxx is not set
...
# CONFIG_PACKAGE_kmod-phy-bcm7xxx is not set
...
# CONFIG_PACKAGE_kmod-phy-maxlinear is not set
# CONFIG_PACKAGE_kmod-phy-micrel is not set
# CONFIG_PACKAGE_kmod-phy-microchip is not set
# CONFIG_PACKAGE_kmod-phy-motorcomm is not set
...
# CONFIG_PACKAGE_kmod-yt6801 is not set
...
# CONFIG_PACKAGE_kmod-team is not set
...
# CONFIG_PACKAGE_kmod-tpm-tis-spi is not set
...
#
# CONFIG_PACKAGE_kmod-rtc-bq32k is not set
...
# CONFIG_PACKAGE_kmod-drm-gpuvm is not set
CONFIG_PACKAGE_kmod-drm-i915=y
# CONFIG_PACKAGE_kmod-drm-ivpu is not set
CONFIG_PACKAGE_kmod-drm-kms-helper=y
# CONFIG_PACKAGE_kmod-drm-nouveau is not set
# CONFIG_PACKAGE_kmod-drm-panel-mipi-dbi is not set
# CONFIG_PACKAGE_kmod-drm-panel-tc358762 is not set
...
# CONFIG_PACKAGE_kmod-drm-xe is not set
...
# CONFIG_PACKAGE_kmod-fb-tft-st7789v is not set
...
# CONFIG_PACKAGE_kmod-vfio is not set
# CONFIG_PACKAGE_kmod-vfio-mdev is not set
# CONFIG_PACKAGE_kmod-vfio-pci is not set
# CONFIG_PACKAGE_kmod-vhost is not set
# CONFIG_PACKAGE_kmod-vhost-net is not set
# CONFIG_PACKAGE_kmod-vsock is not set
# CONFIG_PACKAGE_kmod-vsock-virtio is not set
...
# CONFIG_PACKAGE_kmod-qmi_wwan_s is not set
# end of WWAN Support

#
# Wireless Drivers
#
# CONFIG_PACKAGE_kmod-aic8800-pcie is not set
# CONFIG_PACKAGE_kmod-aic8800-sdio is not set
# CONFIG_PACKAGE_kmod-aic8800-usb is not set
...
# CONFIG_PACKAGE_kmod-mt7990-firmware is not set
...
# CONFIG_PACKAGE_ucode-mod-io is not set
...
# CONFIG_PACKAGE_ucode-mod-zlib is not set
# end of ucode
...
# CONFIG_PACKAGE_efivar is not set
...
# CONFIG_PACKAGE_gnulib-l10n is not set
...
# CONFIG_PACKAGE_libjemalloc is not set
...
# CONFIG_PACKAGE_libmspack is not set
...
# CONFIG_PACKAGE_libnl-cli is not set
...
# CONFIG_PACKAGE_rpcd-mod-rad3-enc is not set
...
# CONFIG_PACKAGE_luci-layer2 is not set
...
# CONFIG_LUCI_LANG_ta is not set
...
# CONFIG_PACKAGE_luci-app-fogvdn is not set
...
# CONFIG_PACKAGE_luci-app-onekeyap is not set
...
# CONFIG_PACKAGE_luci-app-qiyougamebooster is not set
# CONFIG_PACKAGE_luci-app-qos is not set
# CONFIG_PACKAGE_luci-app-radicale3 is not set
# CONFIG_PACKAGE_luci-app-ramfree is not set
# CONFIG_PACKAGE_luci-app-rclone is not set
CONFIG_PACKAGE_luci-app-rclone_INCLUDE_rclone-webui=y
CONFIG_PACKAGE_luci-app-rclone_INCLUDE_rclone-ng=y
# CONFIG_PACKAGE_luci-app-repeater is not set
...
# CONFIG_PACKAGE_luci-app-smartdns_INCLUDE_WebUI is not set
...
# CONFIG_PACKAGE_luci-app-wifihistory is not set
...
# CONFIG_PACKAGE_luci-proto-openvpnc is not set
...
# CONFIG_PACKAGE_luci-proto-vti is not set
...
# CONFIG_PACKAGE_luci-i18n-base-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-ddns-fa is not set
# CONFIG_PACKAGE_luci-i18n-ddns-fi is not set
# CONFIG_PACKAGE_luci-i18n-ddns-fr is not set
# CONFIG_PACKAGE_luci-i18n-ddns-ga is not set
...
# CONFIG_PACKAGE_luci-i18n-ddns-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-ddns-yua is not set
...
# CONFIG_PACKAGE_luci-i18n-firewall-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-ksmbd-fa is not set
...
# CONFIG_PACKAGE_luci-i18n-ksmbd-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-nlbwmon-ga is not set
...
# CONFIG_PACKAGE_luci-i18n-nlbwmon-lt is not set
# CONFIG_PACKAGE_luci-i18n-nlbwmon-mr is not set
# CONFIG_PACKAGE_luci-i18n-nlbwmon-ms is not set
# CONFIG_PACKAGE_luci-i18n-nlbwmon-nl is not set
...
# CONFIG_PACKAGE_luci-i18n-nlbwmon-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-nlbwmon-yua is not set
...
# CONFIG_PACKAGE_luci-i18n-package-manager-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-smartdns-ar is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-bg is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-bn is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ca is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-cs is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-da is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-de is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-el is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-es is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-fi is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-fr is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ga is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-he is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-hi is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-hu is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-it is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ja is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ko is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-lt is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-mr is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ms is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-nl is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-no is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-pl is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-pt is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-pt-br is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ro is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ru is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-sk is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-sv is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-ta is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-tr is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-uk is not set
# CONFIG_PACKAGE_luci-i18n-smartdns-vi is not set
...
# CONFIG_PACKAGE_luci-i18n-upnp-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-wol-da is not set
...
# CONFIG_PACKAGE_luci-i18n-wol-fa is not set
# CONFIG_PACKAGE_luci-i18n-wol-fi is not set
# CONFIG_PACKAGE_luci-i18n-wol-fr is not set
# CONFIG_PACKAGE_luci-i18n-wol-ga is not set
# CONFIG_PACKAGE_luci-i18n-wol-he is not set
# CONFIG_PACKAGE_luci-i18n-wol-hi is not set
...
# CONFIG_PACKAGE_luci-i18n-wol-ko is not set
# CONFIG_PACKAGE_luci-i18n-wol-lt is not set
# CONFIG_PACKAGE_luci-i18n-wol-mr is not set
# CONFIG_PACKAGE_luci-i18n-wol-ms is not set
# CONFIG_PACKAGE_luci-i18n-wol-nl is not set
...
# CONFIG_PACKAGE_luci-i18n-wol-ta is not set
...
# CONFIG_PACKAGE_luci-i18n-wol-yua is not set
...
# CONFIG_MINIUPNPD_IPTABLES_IGDv2 is not set
...
# CONFIG_BIND_JEMALLOC is not set
...
# CONFIG_PACKAGE_ddns-scripts-gcp is not set
# CONFIG_PACKAGE_ddns-scripts-godaddy is not set
# CONFIG_PACKAGE_ddns-scripts-huaweicloud is not set
# CONFIG_PACKAGE_ddns-scripts-luadns is not set
# CONFIG_PACKAGE_ddns-scripts-noip is not set
# CONFIG_PACKAGE_ddns-scripts-ns1 is not set
# CONFIG_PACKAGE_ddns-scripts-nsupdate is not set
# CONFIG_PACKAGE_ddns-scripts-one is not set
# CONFIG_PACKAGE_ddns-scripts-pdns is not set
# CONFIG_PACKAGE_ddns-scripts-porkbun is not set
# CONFIG_PACKAGE_ddns-scripts-route53 is not set
CONFIG_PACKAGE_ddns-scripts-services=y
# CONFIG_PACKAGE_ddns-scripts-transip is not set
# CONFIG_PACKAGE_ddns-scripts-utils is not set
...
# CONFIG_PACKAGE_csshnpd is not set
...
# CONFIG_PACKAGE_ipt2socks-rs is not set
...
# CONFIG_PACKAGE_radicale3 is not set
...
# CONFIG_SING_BOX_BUILD_DHCP is not set
# CONFIG_SING_BOX_BUILD_GRPC is not set
CONFIG_SING_BOX_BUILD_GVISOR=y
# CONFIG_SING_BOX_BUILD_NAIVE_OUTBOUND is not set
CONFIG_SING_BOX_BUILD_QUIC=y
CONFIG_SING_BOX_BUILD_TAILSCALE=y
CONFIG_SING_BOX_BUILD_UTLS=y
# CONFIG_SING_BOX_BUILD_V2RAY_API is not set
...
# CONFIG_PACKAGE_alist is not set
...
# CONFIG_PACKAGE_clouddrive2 is not set
...
# CONFIG_PACKAGE_fogvdn is not set
...
# CONFIG_PACKAGE_ipip6 is not set
...
# CONFIG_PACKAGE_lucky is not set
...
# CONFIG_PACKAGE_mwol is not set
...
# CONFIG_PACKAGE_qiyougamebooster is not set
...
# CONFIG_PACKAGE_openal-soft is not set
...
# Virtualization
#
# CONFIG_PACKAGE_qemu-aarch64-softmmu is not set
...
# CONFIG_PACKAGE_column is not set
...
# CONFIG_PACKAGE_efibootmgr is not set
...
# CONFIG_PACKAGE_last is not set
...
# CONFIG_PACKAGE_wdctl is not set
